              ...
              <div className="flex items-center justify-between">
                ...
                {extractedData && (
                  <div className="flex items-center gap-2">
                    <span className="flex items-center gap-1 rounded bg-yellow-100 px-2 py-0.5 text-xs dark:bg-yellow-900/30">
              ...
              <div className="p-4">
                {!uploadedFile ? (
                  ...
                  <div className="flex h-64 flex-col items-center justify-center text-center">
                    ...
                    <p className="font-medium text-red-600">Erro na extração</p>
                    <p className="text-muted-foreground mt-1 text-sm">
                      {extractionError}
                    </p>
                    <Button
