...
import { MonthlyScorecard } from "./components/monthly-scorecard";
import {
		...
		if (period === "weekly") {
			...
			return Array.from(weeklyData.entries())
				...
				.map(([weekStart, data]) => {
					...
					return {
						date: weekStart,
						displayDate: `Sem ${new Date(weekStart).toLocaleDateString(
							"pt-BR",
							{
								day: "2-digit",
								month: "2-digit",
		...
		<>
			...
			<Main className="flex flex-1 flex-col gap-4 sm:gap-6">
				...
				<Tabs defaultValue="scorecard" className="space-y-4">
					<TabsList>
						<TabsTrigger value="scorecard">Placar Mensal</TabsTrigger>
