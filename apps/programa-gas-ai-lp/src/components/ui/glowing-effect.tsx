          ...
          style={
            {
              ...
              "--gradient":
                variant === "white"
                  ...
                  : `radial-gradient(circle at 50% 0%, #7bb8c8 0%, #7bb8c800 65%),
                repeating-conic-gradient(
                  from 236.84deg at 50% 50%,
                  #5b9aad 0%,
                  #7bb8c8 calc(33% / var(--repeating-conic-gradient-times)),
                  #3a5f6f calc(66% / var(--repeating-conic-gradient-times)),
                  #5b9aad calc(100% / var(--repeating-conic-gradient-times))
                )`,
