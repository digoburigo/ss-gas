...
export type OrganizationGetPayload<Args extends $SelectIncludeOmit<$Schema, "Organization", true>, Options extends $ClientOptions<$Schema> = $ClientOptions<$Schema>> = $SimplifiedModelResult<$Schema, "Organization", Options, Args>;
...
export type MemberGetPayload<Args extends $SelectIncludeOmit<$Schema, "Member", true>, Options extends $ClientOptions<$Schema> = $ClientOptions<$Schema>> = $SimplifiedModelResult<$Schema, "Member", Options, Args>;
...
export type InvitationGetPayload<Args extends $SelectIncludeOmit<$Schema, "Invitation", true>, Options extends $ClientOptions<$Schema> = $ClientOptions<$Schema>> = $SimplifiedModelResult<$Schema, "Invitation", Options, Args>;
...
export type TodoGetPayload<Args extends $SelectIncludeOmit<$Schema, "Todo", true>, Options extends $ClientOptions<$Schema> = $ClientOptions<$Schema>> = $SimplifiedModelResult<$Schema, "Todo", Options, Args>;
...
export type TestGetPayload<Args extends $SelectIncludeOmit<$Schema, "Test", true>, Options extends $ClientOptions<$Schema> = $ClientOptions<$Schema>> = $SimplifiedModelResult<$Schema, "Test", Options, Args>;
...
export type ProductGetPayload<Args extends $SelectIncludeOmit<$Schema, "Product", true>, Options extends $ClientOptions<$Schema> = $ClientOptions<$Schema>> = $SimplifiedModelResult<$Schema, "Product", Options, Args>;
...
export type ClientGetPayload<Args extends $SelectIncludeOmit<$Schema, "Client", true>, Options extends $ClientOptions<$Schema> = $ClientOptions<$Schema>> = $SimplifiedModelResult<$Schema, "Client", Options, Args>;
